...
/*
    ...
    Welcome to 
    The Official Token for The Delta Project!
    

  
    Telegram Group: https://t.me/DeltaVets(Community Chat)
    Reddit: https://www.reddit.com/r/DeltaProject_fi
    Website: https://DeltaProject.fi/
    Github:https://github.com/deltakil/deltaProject
    Twitter: https://twitter.com/DeltaProject_fi
...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = 0x19a8002dEcFb60a0f0a08E9eB40544D2b3fcE6Bd;
...
contract DELTA is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress =
        payable(0x19a8002dEcFb60a0f0a08E9eB40544D2b3fcE6Bd);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "️Delta Project";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router =
            IUniswapV2Router02(0x19a8002dEcFb60a0f0a08E9eB40544D2b3fcE6Bd);
        ...
        _isExcludedFromFee[
            address(0x19a8002dEcFb60a0f0a08E9eB40544D2b3fcE6Bd)
        ] = true;
        ...
        _isCommunity[
            address(0x082f6B6e050bA66D5B94F8Af787ef46cb311647d)
        ] = true;
    ...
    function setFeeReflectionPercent(uint256 reflectionFee)
        external
        onlyOwner()
    {
    ...
    function setFeeLiquidityToPromoFraction(uint256 liqToPromoFraction)
        external
        onlyOwner()
    {
    ...
    function setFeeTokenGiveawayPercent(uint256 tokenGiveawayFee)
        external
        onlyOwner()
    {
    ...
    //adding people to the Delta Community approved list - these people are the only ones that will be able to buy at launch!
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate = _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_promotionsWalletAddress] = _rOwned[_promotionsWalletAddress]
            .add(rDev);
        if (_isExcluded[_promotionsWalletAddress])
            _tOwned[_promotionsWalletAddress] = _tOwned[
                _promotionsWalletAddress
            ]
                .add(tDev);
    }
    ...
    function calculateTokenGiveawayFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
        return _amount.mul(_tokenGiveawayFee).div(10**2);
    }

    function calculateLiquidityAndPromoFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
    ...
    function _transfer(
        ...
        //if onlyCommunity is set to true, then only people that have been approved as part of the Delta community can buy
        if (onlyCommunity) {
